...
export class Migration1583676460269 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "resource_permission" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "createOwn" boolean NOT NULL DEFAULT true, "readOwn" boolean NOT NULL DEFAULT true, "updateOwn" boolean NOT NULL DEFAULT true, "deleteOwn" boolean NOT NULL DEFAULT true, "createAny" boolean NOT NULL DEFAULT false, "readAny" boolean NOT NULL DEFAULT false, "updateAny" boolean NOT NULL DEFAULT false, "deleteAny" boolean NOT NULL DEFAULT false, "resourceId" uuid NOT NULL, "userId" uuid, "roleId" uuid, "type" character varying NOT NULL, CONSTRAINT "PK_3739d06f46b7d8592f25ac81b70" PRIMARY KEY ("id"))`, undefined);
